              ...
              <div className="border-2 border-coffee-cream rounded-lg p-4">
                ...
                <BarcodeScanner 
                  onBarcodeDetected={(barcode) => {
                    // Set the barcode in the form and show a success toast
                    form.setValue("barcode", barcode);
                    toast({
                      title: "Barcode Detected!",
                      description: `Barcode ${barcode} has been scanned. You can now continue with manual entry.`,
                    });
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      if (form.watch("barcode")) {
                        // In a real app, we would search the database or external API
                        // For now, just show a toast and switch to manual tab
                        toast({
                          title: "Barcode Processed",
                          description: "You can now continue with manual entry for this barcode.",
                        });
                        setActiveTab("manual");
                      } else {
                        toast({
